...
public class ControllerTestCaseStructure {

    private CustomResourceLoader loader;
    private JavaCodeBuilder javaCodeBuilder;
    private Integer error = 0;

    public ControllerTestCaseStructure(String testCasePackage, String entityName, String entityClass, String postfix, CustomResourceLoader loader, Set<String> additionalExtends) {
