...
public class JPAScanningConfigurationSupport {
    ...
    public JPAScanningConfigurationSupport(AnnotationMetadata annotationMetadata, AnnotationAttributes attributes, Environment environment){
    ...
    public JPAScanningConfigurationSupport(String[] entityPackage, boolean onlyAnnotations) {
