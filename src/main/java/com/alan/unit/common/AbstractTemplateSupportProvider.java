...
public abstract class AbstractTemplateSupportProvider {
    ...
    public AbstractTemplateSupportProvider(AnnotationAttributes attributes) {
    ...
    public AbstractTemplateSupportProvider(CustomResourceLoader customResourceLoader) {
